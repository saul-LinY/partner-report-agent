...
suite("tenant and role authorization", () => {
  ...
  const token = "tenant-isolation-fixture-token";
  const pluginToken = "plugin-idempotency-fixture-token";
  ...
  beforeAll(async () => {
    await sql.begin(async (tx) => {
      ...
      await tx`insert into partners (id, tenant_id, team_id, user_id, display_name) values (${fixture.partnerA}, ${fixture.tenantA}, ${fixture.teamA}, ${fixture.userA}, 'Fixture A'), (${fixture.partnerB}, ${fixture.tenantB}, ${fixture.teamB}, ${fixture.userB}, 'Fixture B')`;
