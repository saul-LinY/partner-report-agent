...
CREATE INDEX "feishu_partner_bindings_team_status_idx" ON "feishu_partner_bindings" USING btree ("tenant_id","team_id","status");--> statement-breakpoint
CREATE INDEX "outbox_unpublished_idx" ON "outbox_events" USING btree ("published_at","created_at");